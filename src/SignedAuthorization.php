...
class SignedAuthorization
{
     ...
     * @param string $nonce       Nonce de la autorización, hex de 32 bytes. **Es el intent**:
     *                            `keccak256(utf8(id))` del `pi_…`, porque el contrato exige
     *                            `nonce == intentId` para que una firma no pueda aplicarse a otro
     *                            intent. Ya no es un valor aleatorio.
